...
<jsp:directive.page import="org.hibernate.engine.SessionFactoryImplementor"/>
<jsp:directive.page import="org.hibernate.hql.*"/>
<jsp:directive.page import="org.hibernate.hql.ast.*"/>
...
<%
	...
	final Statistics statistics = javax.persistence.EntityManagerFactory.class.cast(appContext.getBean("entityManagerFactory")).createEntityManager().unwrap(Session.class).getSessionFactory().getStatistics(); 
